...
var Model = Ember.Object.extend(Ember.Evented, {
  ...
  */
  ...
  _setup: function() {
    ...
    this._relationships = {};
    /*
      Silent relationships are relationship which have not been declared but the inverse side exists on
      ...
      would have a silent post relationship in order to be do things like remove ourselves from the post
      when we are deleted
    */
    this._silentRelationships = {};
    var model = this;
  ...
  */
  ...
  disconnectRelationships: function() {
    ...
    var model = this;
    forEach.call(Ember.keys(this._silentRelationships), function(key) {
      model._silentRelationships[key].disconnect();
    });
  },
