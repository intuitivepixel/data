...
var Relationship = function(store, record, inverseKey, relationshipMeta) {
  ...
  this.inversKeyForSilent = this.typeKey + this.key;
};
  ...
  addRecord: function(record, idx) {
    if (!this.members.has(record)) {
      ...
      if (this.inverseKey) {
        ...
        if (!record._silentRelationships[this.inverseKeyForSilent]) {
          record._silentRelationships[this.inverseKeyForSilent] = new Relationship(this.store, record, this.key,  {options:{}});
        }
        record._silentRelationships[this.inverseKeyForSilent].addRecord(this.record);
      }
  ...
  removeRecord: function(record) {
    if (this.members.has(record)) {
      ...
      if (this.inverseKey) {
        ...
        if (record._silentRelationships[this.inverseKeyForSilent]) {
          record._silentRelationships[this.inverseKeyForSilent].removeRecord(this.record);
        }
      }
    }
  },
